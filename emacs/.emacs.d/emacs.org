...
#+begin_src emacs-lisp
    ...
    (load-file "~/roaming/projects/MCP servers/ask-user-mcp/emacs/ask-user-popup.el")
      ...
      (use-package agent-shell
        ...
        ;; Fix: evil-collection-comint binds insert-state RET to `newline'
        ;; (because evil-collection-repl-submit-state defaults to 'normal).
        ;; Override so RET submits the prompt in insert mode too.
