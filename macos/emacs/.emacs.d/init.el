...
projectile projects appended below."
      ...
      (mr-x/leader-def
        ...
        "c b" '(mr-x-agent-panel-swap-buffer :wk "Swap panel buffer")
        ...
        "c r" '(mr-x-agent-panel-send-region-no-switch :wk "Send region (stay)")
        "c R" '(mr-x-agent-panel-send-region :wk "Send region (go)")
        "c f" '(mr-x-agent-panel-send-file :wk "Send file")
        "c F" '(mr-x-agent-panel-send-other-file :wk "Send other file")
        "c d" '(agent-shell-send-dwim :wk "Send DWIM (region/error)")
        "c s" '(mr-x-agent-panel-send-screenshot :wk "Send screenshot")
...
the session picker, then spawns shells staggered 3s apart."
    ...
    FILE is used for syntax detection. _BUF is ignored (we insert at point)."
      ...
      (use-package agent-shell-toggle
        :ensure nil
        ...
        :init
        (global-set-key (kbd "s-i") #'mr-x-agent-panel-toggle)
        :commands (mr-x-agent-panel-toggle
                   mr-x-agent-panel-exclude-buffer
                   mr-x-agent-panel-swap-buffer
                   mr-x-agent-panel-set-label
                   mr-x-agent-panel-pick-buffer
                   mr-x-agent-panel-send-region
                   mr-x-agent-panel-send-region-no-switch
                   mr-x-agent-panel-send-file
                   mr-x-agent-panel-send-other-file
                   mr-x-agent-panel-send-screenshot))
